...
#define PIN_CC_CSN      GPIO_PIN_15

#define PORT_CC_IRQ     GPIOB
...
#define EXIT_CC_IRQ_GD0    EXTI0_IRQn         //EXTI9_5_IRQn



// 常量定义
#define SEND_MAX        64       // 发送数据的最大长度
#define My_CC1101_send_data_size_MAX 58
